...
SFR:: The TOE shall combine the input signals to generate a score based on the template configuration that will be reported to the authentication system to determine the lock/unlock status of the device.
